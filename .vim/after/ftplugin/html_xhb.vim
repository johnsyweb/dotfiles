...
" URL:     http://www.american.edu/econ/notes/html_xhb.vim
...
inoremap <buffer> <unique> <htm <c-r>="<html>\n<head>\n<title>".input("title:")."</title>\n</head>\n<body>\n</body>\n</html>"<cr>
...
inoremap <buffer> <unique> <mea <c-r>="  <meta name=\"author\" content=\"".input("author name:")."\" />"<cr>
inoremap <buffer> <unique> <mek <c-r>="  <meta name=\"keywords\" content=\"".input("keywords:")."\" />"<cr>
inoremap <buffer> <unique> <med <c-r>="  <meta name=\"description\" content=\"".input("description:")."\" />"<cr>
